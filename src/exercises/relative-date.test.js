...
describe('Calculate Relative Date', () => {
  ...
  // this month unable to test because of testing framework doensn't support system time mocking.
  it('last month', () => {
  ...
  // this year unable to test because of testing framework doensn't support system time mocking.
  it('last year', () => {
